...
namespace Otc.ComponentModel.DataAnnotations
{
    ...
    {
        private readonly UIHintImplementation implementation;
        ...
        {
            implementation = new UIHintImplementation(uiHint, presentationLayer, controlParameters);
        }

        /// <summary>
        ///     Gets the name of the control that is most appropriate for this associated property or field
        /// </summary>
        public string UIHint => implementation.UIHint;

        /// <summary>
        ///     Gets the name of the presentation layer that supports the control type in <see cref="UIHint" />
        /// </summary>
        public string? PresentationLayer => implementation.PresentationLayer;

        /// <summary>
        ///     Gets the name-value pairs used as parameters to the control's constructor
        /// </summary>
        /// <exception cref="InvalidOperationException"> is thrown if the current attribute is ill-formed.</exception>
        public IDictionary<string, object?> ControlParameters => implementation.ControlParameters;

        public override int GetHashCode() => implementation.GetHashCode();

        public override bool Equals(object? obj) =>
            obj is UIHintAttribute otherAttribute && implementation.Equals(otherAttribute.implementation);

        internal class UIHintImplementation
        {
            private readonly object?[]? inputControlParameters;
            private IDictionary<string, object?>? controlParameters;
            ...
            public UIHintImplementation(string uiHint, string? presentationLayer, params object?[]? controlParameters)
            {
                ...
                {
                    inputControlParameters = new object[controlParameters.Length];
                    Array.Copy(controlParameters, inputControlParameters, controlParameters.Length);
                }
            }
            ...
            public IDictionary<string, object?> ControlParameters =>
                controlParameters ?? (controlParameters = BuildControlParametersDictionary());
            ...
            private IDictionary<string, object?> BuildControlParametersDictionary()
            {
                ...
                object?[]? inputControlParameters = this.inputControlParameters;
