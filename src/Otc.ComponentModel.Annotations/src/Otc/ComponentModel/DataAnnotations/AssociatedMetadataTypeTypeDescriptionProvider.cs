...
namespace Otc.ComponentModel.DataAnnotations
{
    ...
    {
        private readonly Type associatedMetadataType;

        /// <summary>
        /// Initializes a new instance of the Otc.ComponentModel.DataAnnotations.AssociatedMetadataTypeTypeDescriptionProvider
