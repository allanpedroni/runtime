...
namespace Otc.ComponentModel.DataAnnotations
{
    ...
    public sealed class DisplayAttribute : Attribute
    {
        ...
        private readonly LocalizableString groupName = new LocalizableString(nameof(GroupName));
        ...
        public bool AutoGenerateField
        {
            get
            {
                ...
                return autoGenerateField.GetValueOrDefault();
            }
        ...
        public bool AutoGenerateFilter
        {
            get
            {
                ...
                return autoGenerateFilter.GetValueOrDefault();
            }
        ...
        /// </exception>
        public string? GetShortName() => shortName.GetLocalizableValue() ?? GetName();
        ...
        ///     on the <see cref="ResourceType" />.
        /// </exception>
        public string? GetName() => name.GetLocalizableValue();
        ...
        ///     on the <see cref="ResourceType" />.
        /// </exception>
        public string? GetDescription() => description.GetLocalizableValue();
        ...
        ///     on the <see cref="ResourceType" />.
        /// </exception>
        public string? GetPrompt() => prompt.GetLocalizableValue();
        ...
        ///     on the <see cref="ResourceType" />.
        /// </exception>
        public string? GetGroupName() => groupName.GetLocalizableValue();
        ...
        ///     </para>
        /// </returns>
        public bool? GetAutoGenerateField() => autoGenerateField;
        ...
        ///     </para>
        /// </returns>
        public bool? GetAutoGenerateFilter() => autoGenerateFilter;
