...
namespace Otc.ComponentModel.DataAnnotations
{
    ...
    {
        private readonly UIHintAttribute.UIHintImplementation implementation;

        /// <summary>
        /// Gets the name of the control that is most appropriate for this associated
        /// property or field
        /// </summary>
        public string FilterUIHint => implementation.UIHint;
        ...
        {
            implementation = new UIHintAttribute.UIHintImplementation(
        ...
        public override bool Equals(object? obj) =>
            obj is FilterUIHintAttribute otherAttribute && implementation.Equals(otherAttribute.implementation);
    }
}
