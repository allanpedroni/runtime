...
namespace Otc.ComponentModel.DataAnnotations
{
    ...
    {
        private readonly LocalizableString nullDisplayText = new LocalizableString(nameof(NullDisplayText));
        ...
        {
            get => nullDisplayText.Value;
            set => nullDisplayText.Value = value;
        }
        ...
        {
            get => nullDisplayText.ResourceType;
            set => nullDisplayText.ResourceType = value;
        }
        ...
        /// </exception>
        public string? GetNullDisplayText() => nullDisplayText.GetLocalizableValue();
    }
}
