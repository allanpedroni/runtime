...
namespace Otc.ComponentModel.DataAnnotations
{
    ...
    public abstract class ValidationAttribute : Attribute
    {
        ...
        public string? ErrorMessage
        {
            ...
            get => errorMessage ?? defaultErrorMessage;
            set
            {
                errorMessage = value;
                errorMessageResourceAccessor = null;
        ...
        private void SetupResourceAccessor()
        {
            if (errorMessageResourceAccessor == null)
            {
                ...
                else
                {
                    ...
                    errorMessageResourceAccessor = () => localErrorMessage!;
                }
            }
        }
        ...
        {
            Debug.Assert(errorMessageResourceType != null);
            Debug.Assert(!string.IsNullOrEmpty(errorMessageResourceName));
