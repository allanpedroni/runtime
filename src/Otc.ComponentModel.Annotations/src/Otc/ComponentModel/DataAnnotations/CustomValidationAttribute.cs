...
namespace Otc.ComponentModel.DataAnnotations
{
    ...
    public sealed class CustomValidationAttribute : ValidationAttribute
    {
        ...
        private readonly Lazy<string?> malformedErrorMessage;
        private bool isSingleArgumentMethod;
        private string? lastMessage;
        private MethodInfo? methodInfo;
        private Type? firstParameterType;
        private Tuple<string, Type>? typeId;
            ...
            : base(() => SR.CustomValidationAttribute_ValidationError)
        {
            ...
            Method = method;
            malformedErrorMessage = new Lazy<string?>(CheckAttributeWellFormed);
        }
        ...
        public override object TypeId
        {
            get
            {
                if (typeId is null)
                {
                    typeId = new Tuple<string, Type>(Method, ValidatorType);
                }
        ...
        protected override ValidationResult? IsValid(object? value, ValidationContext validationContext)
        {
            ...
            try
            {
                ...
                var methodParams = isSingleArgumentMethod
        ...
        public override string FormatErrorMessage(string name)
        {
            ...
            {
                return string.Format(CultureInfo.CurrentCulture, lastMessage, name);
            }
        ...
        private string? ValidateMethodParameter()
        {
            ...
            // 1-parameter form is ValidationResult Method(object value)
            // 2-parameter form is ValidationResult Method(object value, ValidationContext context),
            isSingleArgumentMethod = (parameterInfos.Length == 1);

            if (!isSingleArgumentMethod)
            {
            ...
            firstParameterType = parameterInfos[0].ParameterType;
            return null;
        }
        ...
        {
            string? errorMessage = malformedErrorMessage.Value;
        ...
        {
            convertedValue = null;
            var expectedValueType = firstParameterType!;
