...
namespace Otc.ComponentModel.DataAnnotations
{
        ...
        : IServiceProvider
    {
        ...
        public ValidationContext(object instance, IServiceProvider? serviceProvider, IDictionary<object, object?>? items)
        {
            ...
            this.items = items != null ? new Dictionary<object, object?>(items) : new Dictionary<object, object?>();
        ...
        public object? GetService(Type serviceType) => serviceProvider?.Invoke(serviceType);
