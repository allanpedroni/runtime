...
namespace Otc.ComponentModel.Annotations.Tests
{
    public class CompareAttributeTests : ValidationAttributeTestBase
    {
        ...
        private static ValidationContext context = new ValidationContext(new CompareObject("a")) { DisplayName = "CurrentProperty" };
        protected override IEnumerable<TestCase> InvalidValues() => new TestCase[]
        {
            new TestCase(new CompareAttribute(nameof(CompareObject.CompareProperty)), "b", context),
            new TestCase(new CompareAttribute(nameof(CompareObject.ComparePropertyWithDisplayName)), "b", context),
            new TestCase(new CompareAttribute("NoSuchProperty"), "b", context),
        ...
        public static void Validate_Indexer_ThrowsArgumentException_Netcoreapp()
        {
            ...
            AssertExtensions.Throws<ArgumentException>(null, () => attribute.Validate("b", context));
        }
        ...
        public static void Validate_LowerAndUpperPropertyName_Success()
        {
            ...
            Assert.NotNull(attribute.GetValidationResult("b", context).ErrorMessage);
        ...
        public static void Validate_PrivateProperty_ThrowsArgumentException()
        {
            ...
            Assert.Throws<ValidationException>(() => attribute.Validate("b", context));
        }
