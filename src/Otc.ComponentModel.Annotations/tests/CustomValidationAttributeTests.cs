...
namespace Otc.ComponentModel.Annotations.Tests
{
    ...
    {
        private static readonly ValidationContext testValidationContext = new ValidationContext(new object());
        ...
        {
            CustomValidationAttribute attribute = new CustomValidationAttribute(validatorType, method);
            Assert.Throws<InvalidOperationException>(() => attribute.Validate("Does not matter", testValidationContext));
        }
        ...
        public static void Validate_IConvertibleThrowsCustomException_IsNotCaught()
        {
            ...
            Assert.Throws<ArithmeticException>(() => attribute.Validate(new IConvertibleImplementor() { IntThrow = new ArithmeticException() }, testValidationContext));
        }
        ...
        public static void Validate_MethodThrowsCustomException_IsNotCaught()
        {
            ...
            AssertExtensions.Throws<ArgumentException>(null, () => attribute.Validate(new IConvertibleImplementor(), testValidationContext));
        }
        ...
        public static void GetValidationResult_MethodReturnDerivedValidationResult_ReturnsExpected()
        {
            ...
            ValidationResult validationResult = attribute.GetValidationResult(new object(), testValidationContext);
