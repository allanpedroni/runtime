...
namespace Otc.ComponentModel.Annotations.Tests
{
    public class ValidationAttributeTests
    {
        ...
        public static void TestThrowIfNoOverrideIsValid02()
        {
            var attribute = new ValidationAttributeNoOverrides();
            Assert.Throws<NotImplementedException>(
                () => attribute.Validate("Object to validate does not matter - no override of IsValid", testValidationContext));
        }
        ...
        {
            var attribute = new ValidationAttributeOverrideOneArgIsValid();
            attribute.Validate("Valid Value", testValidationContext);
        }
        ...
        {
            var attribute = new ValidationAttributeOverrideBothIsValids();
            Assert.Throws<ValidationException>(() => attribute.Validate("Valid 1-Arg Value", testValidationContext));
            attribute.Validate("Valid 2-Args Value", testValidationContext);
        }
        ...
        {
            var attribute = new ValidationAttributeOverrideOneArgIsValid();
            attribute.GetValidationResult("Valid Value", testValidationContext);
        }
