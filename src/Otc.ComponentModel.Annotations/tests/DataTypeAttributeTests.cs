...
namespace Otc.ComponentModel.Annotations.Tests
{
    public class DataTypeAttributeTests : ValidationAttributeTestBase
    {
        ...
        private static readonly DataType[] dataTypes = (DataType[])Enum.GetValues(typeof(DataType));
        public static IEnumerable<object[]> DataTypes_TestData => dataTypes.Select(type => new object[] { type });
        ...
        public static void Ctor_String(string customDataType, bool valid)
        {
            ...
            else
            {
                ...
                Assert.Throws<InvalidOperationException>(() => attribute.Validate(new object(), testValidationContext));
            }
        }
